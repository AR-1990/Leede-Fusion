...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> | Leede Admin</title>
            ...
            <header class="admin-header admin-header-premium">
                ...
                <div class="admin-user-profile admin-header-user">
                    <div class="admin-user-text">
                        <span class="admin-name" x-text="$store.auth.user?.name || '<?php echo e(auth()->user()->name ?? 'Leede Admin'); ?>'"></span>
...
<?php /**PATH /Users/mac/Documents/Wahla-Cloth-House/resources/views/layouts/admin.blade.php ENDPATH**/ ?>