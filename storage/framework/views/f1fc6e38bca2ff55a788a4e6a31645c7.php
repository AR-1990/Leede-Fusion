<section class="hero-container" x-data="heroSlider(<?php echo \Illuminate\Support\Js::from($heroSlides)->toHtml() ?>)" @mouseenter="pause()" @mouseleave="resume()">
    <div class="hero" :class="slides[current]?.theme === 'light' ? 'hero-theme-light' : 'hero-theme-dark'">
        ...
        <div class="hero-center-content">
            ...
            <div class="hero-btn-group reveal reveal-fade-up delay-400">
                ...
                <a
                    :href="slides[current]?.secondary_btn_url || '<?php echo e(url('/collections')); ?>'"
...
<?php /**PATH C:\Users\AR\Desktop\Leede-Fusion\resources\views/sections/hero.blade.php ENDPATH**/ ?>