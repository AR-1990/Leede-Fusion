<?php $__env->startSection('title', 'Bespoke Atelier & Contact Us | Leede Fusion'); ?>
<?php $__env->startSection('description', 'Bring your own design, get bespoke clothes stitched, explore ready collections, or book bulk B2B manufacturing with Leede Fusion Karachi.'); ?>
        ...
        <section class="contact-hero-luxury">
            <div class="contact-hero-container reveal reveal-fade-up">
                ...
                <div class="quick-channels-grid reveal reveal-fade-up delay-100">
                    ...
                    <a href="https://wa.me/<?php echo e(config('content.project.whatsapp_international', '923066978156')); ?>?text=<?php echo e(urlencode('Hi Leede Fusion! I have a design photo and want to get clothes stitched. Can you please guide me?')); ?>" target="_blank" rel="noopener noreferrer" class="quick-channel-card">
                        <div class="quick-channel-header">
                            <span class="quick-channel-icon">
                ...
                <div class="contact-wrapper-grid">
                    ...
                    <div class="contact-form-card reveal reveal-fade-up">
                        ...
                        <div class="whatsapp-atelier-callout">
                            ...
                            <a
                                href="https://wa.me/<?php echo e(config('content.project.whatsapp_international', '923066978156')); ?>?text=<?php echo e(urlencode('Hi Leede Fusion! I want to get custom clothes stitched. Here is my design picture:')); ?>"
                                target="_blank"
                    ...
                    <div id="studio-location" class="boutique-info-column reveal reveal-fade-up delay-150">
                        <div class="boutique-card">
                            ...
                            <div class="boutique-detail-list">
                                <div class="boutique-detail-row">
                                    ...
                                    <div>
                                        ...
                                        <div class="boutique-detail-val"><?php echo e(config('content.project.location', 'Karachi, Sindh, Pakistan')); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="boutique-detail-row">
                                    ...
                                    <div>
                                        ...
                                        <div class="boutique-detail-val"><?php echo e(config('content.project.hours', 'Mon - Sun: 9:00 AM – 9:00 PM (All 7 Days)')); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="boutique-detail-row">
                                    ...
                                    <div>
                                        ...
                                        <div class="boutique-detail-val">
                                            <a href="tel:<?php echo e(config('content.project.phone', '03066978156')); ?>" style="font-weight: 700; color: #111;">
                                                <?php echo e(config('content.project.phone', '0306 6978156')); ?>

                                            </a><br>
                                            <a href="mailto:<?php echo e(config('content.project.email', 'leede@gmail.com')); ?>" style="color: #6b7280; font-size: 13px;">
                                                <?php echo e(config('content.project.email', 'leede@gmail.com')); ?>
                            ...
                            <a href="https://wa.me/<?php echo e(config('content.project.whatsapp_international', '923066978156')); ?>?text=<?php echo e(urlencode('Hi Leede Fusion! I would like to inquire about custom stitching and your collections.')); ?>"
                               target="_blank"
                               rel="noopener noreferrer"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AR\Desktop\Leede-Fusion\resources\views/contact.blade.php ENDPATH**/ ?>