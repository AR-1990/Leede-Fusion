<?php $__env->startSection('title', 'Customer Inquiries'); ?>
<?php $__env->startSection('page_title', 'Customer Inquiries'); ?>
<?php $__env->startSection('page_subtitle', 'Review, manage, and respond to incoming contact messages'); ?>

<?php $__env->startSection('content'); ?>
<div class="inquiries-portal-wrap" x-data="{
    inquiries: <?php echo e(Js::from($inquiries)); ?>,
    stats: <?php echo e(Js::from($stats)); ?>,
    activeFilter: 'all',
    searchQuery: '',
    selected: null,
    editStatus: 'unread',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac/Documents/GitHub/Leede-Fusion/resources/views/admin/inquiries.blade.php ENDPATH**/ ?>