...
@section('title', 'Our Story | Leede Fusion')
    ...
    <div class="section-container" style="max-width: 1400px; margin: 0 auto; padding: 0 40px;">
        <div class="story-grid">
            <div class="story-text reveal reveal-slide-left">
                <h2>THE GENESIS</h2>
                <p>
                    Founded with a passion for exceptional textiles, Leede Fusion represents the intersection
        ...
        <div class="story-grid reverse">
            <div class="story-text reveal reveal-slide-right">
                ...
                <p>
                    ...
                    Leede Fusion brings a new standard of accessible luxury.
                </p>
