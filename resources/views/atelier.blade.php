...
@section('title', 'The Atelier — Fabric Library, Studio Tools & Custom Design | Leede Fusion')
@section('description', 'Where Ideas Become Designs. Explore our studio creative pipeline, curated fabric library, and interactive custom idea visualizer.')
    ...
    <div class="the-house-page">
        ...
        <main class="house-narrative-container">
            ...
            <section class="house-chapter reveal reveal-fade-up" id="visualizer" x-data="atelierVisualizerTool()">
                ...
                {{-- Clean White Concept Summary Box (Matching Reference Screenshot 3) --}}
            ...
            {{-- 03 / DESIGN PHILOSOPHY & OUR APPROACH --}}
            ...
            {{-- 05 / BOTTOM MASTER CTA --}}
            <div class="house-cta-wrapper reveal reveal-fade-up">
                <a href="{{ route('contact') }}?inquiry=Custom+Stitching" class="house-primary-cta-btn">
...
function atelierVisualizerTool() {
    return {
        ...
        proceedWithConcept() {
            ...
            window.location.href = `{{ route('contact') }}?inquiry=Custom+Stitching&concept=${encoded}`;
        }
    };
}
</script>
